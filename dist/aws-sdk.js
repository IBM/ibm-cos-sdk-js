// AWS SDK for JavaScript v1.2.2-0
...
module.exports = {
  S3: require('./s3')};
},{"../lib/core":10,"../lib/node_loader":8,"./s3":6}],6:[function(require,module,exports){
require('../lib/node_loader');
var AWS = require('../lib/core');
...
},{"../apis/s3-2006-03-01.min.json":2,"../apis/s3-2006-03-01.paginators.json":3,"../apis/s3-2006-03-01.waiters2.json":4,"../lib/api_loader":7,"../lib/core":10,"../lib/node_loader":8,"../lib/service":39,"../lib/services/s3":40}],7:[function(require,module,exports){
...
},{"./api_loader":7,"./core":10,"./http/xhr":15,"./util":51,"./xml/browser_parser":52,"_process":67,"buffer/":56,"crypto-browserify":58,"querystring/":74,"url/":75}],9:[function(require,module,exports){
var AWS = require('./core');
require('./credentials');
...
AWS.Config = AWS.util.inherit({
  ...
  extractCredentials: function extractCredentials(options) {
    if ((options.accessKeyId && options.secretAccessKey) ||
      ...
      if (options.credentials.tokenManager) {
...
},{"./core":10,"./credentials":11,"./credentials/credential_provider_chain":12}],10:[function(require,module,exports){
...
},{"./config":9,"./credentials":11,"./credentials/credential_provider_chain":12,"./event_listeners":13,"./http":14,"./json/builder":17,"./json/parser":18,"./model/api":19,"./model/operation":21,"./model/paginator":22,"./model/resource_waiter":23,"./model/shape":24,"./param_validator":25,"./protocol/json":26,"./protocol/query":27,"./protocol/rest":28,"./protocol/rest_json":29,"./protocol/rest_xml":30,"./request":34,"./resource_waiter":35,"./response":36,"./sequential_executor":38,"./service":39,"./signers/request_signer":43,"./util":51,"./xml/builder":53}],11:[function(require,module,exports){
var AWS = require('./core');
...
},{"./core":10,"./iam/token_manager":16}],12:[function(require,module,exports){
var AWS = require('../core');
    ...
    addAsync('SIGN', 'sign', function SIGN(req, done) {
      ...
      service.config.getCredentials(function (err, credentials) {
        ...
        try {
          ...
          signer.addAuthorization(credentials, date, req);
          req.signedAt = date;
        } catch (e) {
...
},{"./core":10,"./protocol/json":26,"./protocol/query":27,"./protocol/rest":28,"./protocol/rest_json":29,"./protocol/rest_xml":30,"./sequential_executor":38,"util":78}],14:[function(require,module,exports){
var AWS = require('./core');
...
},{"../core":10,"../http":14,"events":63}],16:[function(require,module,exports){
...
TokenManager.prototype.createToken = function(tokenConfig) {
    ...
    if (this.token.expiration) {
        ...
        setTimeout(function preemptiveRefresh(attempt) {
            this.refreshToken(function(err) {
                if (err && attempt < 2) {
                    setTimeout(preemptiveRefresh, 30000, attempt + 1);
                }
            });
...
},{"../../lib/core":10,"querystring":71}],17:[function(require,module,exports){
var util = require('../util');
...
},{"../util":51,"./collection":20,"./operation":21,"./paginator":22,"./resource_waiter":23,"./shape":24}],20:[function(require,module,exports){
...
},{"../util":51}],21:[function(require,module,exports){
var Shape = require('./shape');
...
},{"../util":51,"./shape":24}],22:[function(require,module,exports){
...
},{"../util":51}],23:[function(require,module,exports){
var util = require('../util');
var property = util.property;
...
},{"../util":51}],24:[function(require,module,exports){
var Collection = require('./collection');
...
},{"../util":51,"./collection":20}],25:[function(require,module,exports){
var AWS = require('./core');
...
},{"./core":10}],26:[function(require,module,exports){
var util = require('../util');
...
},{"../json/builder":17,"../json/parser":18,"../util":51}],27:[function(require,module,exports){
var AWS = require('../core');
var util = require('../util');
...
},{"../core":10,"../model/shape":24,"../query/query_param_serializer":31,"../util":51}],28:[function(require,module,exports){
var util = require('../util');
...
},{"../json/builder":17,"../json/parser":18,"../util":51,"./json":26,"./rest":28}],30:[function(require,module,exports){
var AWS = require('../core');
var util = require('../util');
var Rest = require('./rest');
...
},{"../core":10,"../util":51,"./rest":28}],31:[function(require,module,exports){
var util = require('../util');
...
},{"../util":51}],32:[function(require,module,exports){
module.exports={
  "rules": {
    "*/*": {
...
},{"./region_config.json":32,"./util":51}],34:[function(require,module,exports){
(function (process){
var AWS = require('./core');
...
},{"./core":10,"./state_machine":50,"_process":67,"jmespath":66}],35:[function(require,module,exports){
...
},{"./core":10,"jmespath":66}],36:[function(require,module,exports){
var AWS = require('./core');
var inherit = AWS.util.inherit;
var jmespath = require('jmespath');
...
},{"./core":10,"jmespath":66}],37:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":10}],38:[function(require,module,exports){
var AWS = require('./core');
...
},{"./core":10}],39:[function(require,module,exports){
var AWS = require('./core');
...
},{"./core":10,"./model/api":19,"./region_config":33}],40:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":10,"../s3/managed_upload":37,"../signers/v4_credentials":49}],41:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":10,"./iam":41,"./presign":42,"./s3":44,"./v2":45,"./v3":46,"./v3https":47,"./v4":48}],44:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":10}],46:[function(require,module,exports){
var AWS = require('../core');
var inherit = AWS.util.inherit;
...
},{"../core":10,"./v3":46}],48:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":10,"./v4_credentials":49}],49:[function(require,module,exports){
var AWS = require('../core');
...
},{"../core":10}],50:[function(require,module,exports){
...
},{"../apis/metadata.json":1,"./core":10,"_process":67,"fs":55,"uuid":80}],52:[function(require,module,exports){
var util = require('../util');
var Shape = require('../model/shape');
...
},{"../model/shape":24,"../util":51}],53:[function(require,module,exports){
var util = require('../util');
...
},{"../util":51,"xmlbuilder":97}],54:[function(require,module,exports){
'use strict'
...
},{"base64-js":54,"ieee754":64,"isarray":65}],57:[function(require,module,exports){
...
},{"./md5":59,"./rng":60,"./sha":61,"./sha256":62,"buffer":56}],59:[function(require,module,exports){
...
},{"./decode":72,"./encode":73,"dup":71}],75:[function(require,module,exports){
...
},{"punycode":68,"querystring":71}],76:[function(require,module,exports){
...
},{"./support/isBuffer":77,"_process":67,"inherits":76}],79:[function(require,module,exports){
(function (global){
...
},{"./lib/rng":79}],81:[function(require,module,exports){
(function() {
...
},{"./XMLNode":92,"lodash/object/create":140}],97:[function(require,module,exports){
(function() {
...
},{"./XMLBuilder":82,"lodash/object/assign":139}],98:[function(require,module,exports){
...
},{"../object/keys":141,"./baseCopy":102}],101:[function(require,module,exports){
...
},{"../lang/isObject":136}],104:[function(require,module,exports){
...
},{"./baseForOwn":107,"./isLength":125,"./toObject":130}],105:[function(require,module,exports){
...
},{"./toObject":130}],107:[function(require,module,exports){
...
},{"../object/keys":141,"./baseFor":106}],108:[function(require,module,exports){
...
},{"./baseIsEqualDeep":109}],109:[function(require,module,exports){
...
},{"./baseIsEqual":108}],112:[function(require,module,exports){
...
},{"../object/keys":141,"./baseIsMatch":111,"./isStrictComparable":127}],113:[function(require,module,exports){
var baseIsEqual = require('./baseIsEqual'),
    isStrictComparable = require('./isStrictComparable');
...
},{"./baseIsEqual":108,"./isStrictComparable":127}],114:[function(require,module,exports){
...
},{"../utility/identity":145,"./metaMap":128}],116:[function(require,module,exports){
...
},{"../utility/identity":145}],118:[function(require,module,exports){
...
},{"../clients/browser_default":5,"./browser_loader":8,"./core":10}]},{},[146]);
