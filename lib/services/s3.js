...
AWS.util.update(AWS.S3.prototype, {
  ...
  getSignatureVersion: function getSignatureVersion(request) {
    ...
    */
    ...
    // If IBM auth tokens are being used, always return 'iam'
  ...
  computableChecksumOperations: {
    ...
    putBucketProtectionConfiguration: true,  // IBM-specific addition
    completeMultipartUpload: true,  // IBM-specific addition (required when using BucketProtection)
