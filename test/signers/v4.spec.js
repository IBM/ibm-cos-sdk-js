...
(function() {
  ...
  buildRequest = function() {
    ...
    req = s3.makeRequest('putBucket', {
      Bucket: 'bår'
    });
    req.build();
    req.httpRequest.headers['X-Amz-User-Agent'] = 'ibm-cos-sdk-js/0.1';
    return req.httpRequest;
  };

  buildSigner = function(request, options) {
    return new AWS.Signers.V4(request || buildRequest(), 's3', options);
  };
  ...
  describe('AWS.Signers.V4', function() {
    ...
    creds = null;
    signature = 'c6e46c62c81ec8a29e0c1bd4ba2883416ccc98e573adeafe39c088177e63f44c';
    authorization = 'AWS4-HMAC-SHA256 Credential=akid/20310430/region/s3/aws4_request, SignedHeaders=x-amz-date;x-amz-security-token;x-amz-user-agent, Signature=' + signature;
    signer = null;
    beforeEach(function() {
      helpers.spyOn(AWS.util, 'userAgent').andReturn('ibm-cos-sdk-js/0.1');
      creds = {
        accessKeyId: 'akid',
    ...
    describe('addAuthorization', function() {
      ...
      headers = {
        ...
        'X-Amz-User-Agent': 'ibm-cos-sdk-js/0.1',
        'X-Amz-Date': datetime,
    ...
    describe('signature', function() {
      ...
      return xit('should not compute SHA 256 checksum more than once', function() {
        var spy;
        // TODO(kellerbr) Why is this failing?
    ...
    describe('canonicalHeaders', function() {
      it('should return headers', function() {
        return expect(signer.canonicalHeaders()).to.eql(['x-amz-date:' + datetime, 'x-amz-security-token:session', 'x-amz-user-agent:ibm-cos-sdk-js/0.1'].join('\n'));
      });
