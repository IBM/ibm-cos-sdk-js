  ...
  describe('AWS.Model.Shape', function() {
    ...
    return describe('TimestampShape', function() {
      it('can be inherited', function() {
        ...
        return expect(shape.members.Date.timestampFormat).to.eql('iso8601');
      });
      it('prefers rfc822 if header', function() {
        ...
        return expect(shape.members.Date.timestampFormat).to.eql('rfc822');
      });
      ...
      it('will use api metadata timestampFormat if not found elsewhere', function() {
        ...
        return expect(shape.members.Date.timestampFormat).to.eql('unixTimestamp');
      });
