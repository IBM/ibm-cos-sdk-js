...
(function() {
  var AWS, MockService, helpers, metadata, MockServiceFromApi,
  ...
  describe('AWSQuery compatible error codes', function () {
    ...
    it('can receive error code when header is incomplete', function () {
      helpers.mockHttpResponse(500, {'x-amzn-query-error': 'AwsQueryError-Sender'}, ['ServiceError']);
      return (service.makeRequest('operation', {}, function (err, data) {
        expect(err.code).to.equal('ServiceError');
        expect(err.statusCode).to.equal(500);
        return expect(data).to.equal(null);
